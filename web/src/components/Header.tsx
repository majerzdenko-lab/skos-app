...
export default function Header() {
  ...
  return (
    <header className="border-b border-gray-200 bg-white">
      <div className="max-w-7xl mx-auto px-4 h-16 md:h-28 flex items-center justify-between gap-4">

        {/* SKoS logo */}
        <div className="flex items-center shrink-0">
          <img src="/skos-logo.jpg" alt="Slovenský kosecký spolok" className="h-12 md:h-24 w-auto" />
        </div>
